...
## все запросы кратко:
![image](task_6/images/all_query_status_OK.png)

## все запросы подробно:

### ○ 1 Чтение всех юзеров
![image](task_6/images/users/GET_all_users.png)

### ○ 2 Чтение одного юзера
![image](task_6/images/users/GET_concrete_user.png)
...
### ○ 5 Удаление юзера
![image](task_6/images/users/DELETE_query_user.png)

### ○ 6 Чтение всех товаров
![image](task_6/images/products/GET_all_products.png)

### ○ 7 Чтение одного товара
![image](task_6/images/products/GET_concrete_product.png)
...
![image](task_6/images/orders/GET_concrete_order.png)
